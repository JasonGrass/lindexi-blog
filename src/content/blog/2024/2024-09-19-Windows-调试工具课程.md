...
modDatetime: 2025-02-21 22:21:45
slug: Windows-调试工具课程
...
<!-- ![](images/img-Windows 调试工具课程0.png) -->
...
<!-- ![](images/img-Windows 调试工具课程1.png) -->
![](images/img-modify-2f343f098004f03e661a10e0888448a9.jpg)

本次的课程的开始我来和大家讲一个调试故事，这个故事是从用户反馈软件用不了的问题开始的

<!-- 需求分析 -->
<!-- ![](images/img-Windows 调试工具课程2.png) -->
![](images/img-modify-0112b96f6a08b458e752c21b4d2bf517.jpg)

用户说软件用不了，那可能会是什么问题呢？用户不是专业的开发人员，他们不知道如何准确的表述问题

<!-- 调查思路 -->
<!-- ![](images/img-Windows 调试工具课程4.png) -->
...
<!-- ![](images/img-Windows 调试工具课程5.png) -->
...
<!-- ![](images/img-Windows 调试工具课程6.png) -->
...
<!-- Windows 是咱的好朋友 -->
<!-- ![](images/img-Windows 调试工具课程3.png) -->
...
<!-- 寻找痕迹-事件查看器 -->
<!-- ![](images/img-Windows 调试工具课程7.png) -->
...
<!-- 举个栗子 -->
<!-- ![](images/img-Windows 调试工具课程8.png) -->
![](images/img-modify-ede92d0f13d27a6a898daa22bbabc0c8.jpg)
...
<!-- 事件查看器 - 日常不工作 -->
<!-- ![](images/img-Windows 调试工具课程9.png) -->
...
<!-- ![](images/img-Windows 调试工具课程10.png) -->
...
<!-- ![](images/img-Windows 调试工具课程11.png) -->
...
<!-- ![](images/img-Windows 调试工具课程12.png) -->
...
<!-- ![](images/img-Windows 调试工具课程13.png) -->
...
<!-- ![](images/img-Windows 调试工具课程14.png) -->
...
<!-- 如何分析 DUMP 文件 -->
<!-- ![](images/img-Windows 调试工具课程15.png) -->
...
<!-- ![](images/img-Windows 调试工具课程16.png) -->
...
<!-- ![](images/img-Windows 调试工具课程97.png) -->
...
<!-- ![](images/img-Windows 调试工具课程18.png) -->
...
<!-- ![](images/img-Windows 调试工具课程19.png) -->
...
<!-- ![](images/img-Windows 调试工具课程20.png) -->
...
<!-- ![](images/img-Windows 调试工具课程21.png) -->
...
<!-- ![](images/img-Windows 调试工具课程22.png) -->
...
<!-- ![](images/img-Windows 调试工具课程17.png) -->
![](images/img-modify-dcbbfc5c1fbbe38cc68e49765f56be6a.jpg)

大家猜猜上面堆栈告诉咱什么问题

<!-- 堆栈是个好东西 谁卡住了我的主线程 - CPU 不动 -->
<!-- ![](images/img-Windows 调试工具课程23.png) -->
![](images/img-modify-2c7a64441006299e448e56a12cd07e84.jpg)
...
<!-- ![](images/img-Windows 调试工具课程24.png) -->
...
<!-- ![](images/img-Windows 调试工具课程25.png) -->
...
<!-- ![](images/img-Windows 调试工具课程26.png) -->
...
<!-- ![](images/img-Windows 调试工具课程27.png) -->
...
<!-- 这个方法有逻辑跑满了，跑了什么？ -->
<!-- ![](images/img-Windows 调试工具课程28.png) -->
...
<!-- ![](images/img-Windows 调试工具课程32.png) -->
...
<!-- ![](images/img-Windows 调试工具课程33.png) -->
...
<!-- 局部变量也是好东西 - 错误码含义哪里找 -->
<!-- ![](images/img-Windows 调试工具课程34.png) -->
...
<!-- ![](images/img-Windows 调试工具课程36.png) -->
...
<!-- ![](images/img-Windows 调试工具课程35.png) -->
...
<!-- 图片/音视频投了什么毒？延伸一下 -->
<!-- ![](images/img-Windows 调试工具课程37.png) -->
...
<!-- 好像… 还是有些问题调试不出来 -->
<!-- ![](images/img-Windows 调试工具课程38.png) -->
...
<!-- ![](images/img-Windows 调试工具课程39.png) -->
...
<!-- ![](images/img-Windows 调试工具课程40.png) -->
...
<!-- ![](images/img-Windows 调试工具课程41.png) -->
...
<!-- ![](images/img-Windows 调试工具课程42.png) -->
![](images/img-modify-34a424768fb3fc3146c88934a8e8681c.jpg)

首要介绍的就是 ProcDump 工具

<!-- ![](images/img-Windows 调试工具课程43.png) -->
...
<!-- ![](images/img-Windows 调试工具课程44.png) -->
...
<!-- ![](images/img-Windows 调试工具课程45.png) -->
...
<!-- ![](images/img-Windows 调试工具课程48.png) -->
...
<!-- ![](images/img-Windows 调试工具课程49.png) -->
![](images/img-modify-a250d60cf89879b1442f5ff60168644e.jpg)

来和大家讲讲事后现场的调查

<!-- ![](images/img-Windows 调试工具课程50.png) -->
...
<!-- 事后现场？团伙作案？ -->
<!-- ![](images/img-Windows 调试工具课程51.png) -->
...
<!-- 举个真实栗子 -->
<!-- ![](images/img-Windows 调试工具课程52.png) -->
![](images/img-modify-ea9e5f68d7025cbc4fc3581cae9d0bf4.jpg)
...
<!-- ![](images/img-Windows 调试工具课程53.png) -->
...
<!-- ![](images/img-Windows 调试工具课程54.png) -->
...
<!-- ![](images/img-Windows 调试工具课程55.png) -->
![](images/img-modify-cfb1ea6772a8de94036412c6f3b00bc3.jpg)

再根据前面的 Process Monitor 工具抓到的在进程退出之前碰的是 Realtek Bluetooth 蓝牙模块，于是重心就在 Shell32 和蓝牙一起组合上面

<!-- ![](images/img-Windows 调试工具课程56.png) -->
...
<!-- ![](images/img-Windows 调试工具课程57.png) -->
...
<!-- 事后现场 -->
<!-- ![](images/img-Windows 调试工具课程58.png) -->
...
<!-- ![](images/img-Windows 调试工具课程62.png) -->
...
<!-- ![](images/img-Windows 调试工具课程63.png) -->
![](images/img-modify-3eaf4bd40bbcfedb359e8fce79b6dc3c.jpg)

先来聊聊依赖缺失问题

<!-- ![](images/img-Windows 调试工具课程64.png) -->
...
<!-- 找不到，找错 DLL -->
<!-- ![](images/img-Windows 调试工具课程65.png) -->
...
<!-- ![](images/img-Windows 调试工具课程66.png) -->
...
<!-- ![](images/img-Windows 调试工具课程67.png) -->
...
<!-- ![](images/img-Windows 调试工具课程68.png) -->
![](images/img-modify-c808a5a239d7aab7fc1d8dbd0b2df024.jpg)

使用 Dependencies 工具除了找依赖缺失之外，还可以用来找到是否被投毒的问题。如上图所示，看大家是否能够快速看出来问题

<!-- ![](images/img-Windows 调试工具课程69.png) -->
...
<!-- ![](images/img-Windows 调试工具课程73.png) -->
...
<!-- dotMemory -->
<!-- ![](images/img-Windows 调试工具课程74.png) -->
![](images/img-modify-f0db913c096a6c5bc5839cc8f6f6fa3e.jpg)
...
<!-- ![](images/img-Windows 调试工具课程75.png) -->
...
<!-- ![](images/img-Windows 调试工具课程76.png) -->
...
<!-- ![](images/img-Windows 调试工具课程77.png) -->
![](images/img-modify-9836eda96ce3ed6ed2dbb597ec068b99.jpg)
...
<!-- ![](images/img-Windows 调试工具课程81.png) -->
...
<!-- ![](images/img-Windows 调试工具课程84.png) -->
...
<!-- ![](images/img-Windows 调试工具课程85.png) -->
...
<!-- ![](images/img-Windows 调试工具课程86.png) -->
...
<!-- ![](images/img-Windows 调试工具课程87.png) -->
![](images/img-modify-aefc960fc626a8da0d4b632c920dd29c.jpg)

接下来看看窗口相关模块的问题

<!-- ![](images/img-Windows 调试工具课程88.png) -->
...
<!-- ![](images/img-Windows 调试工具课程89.png) -->
...
<!-- ![](images/img-Windows 调试工具课程90.png) -->
...
<!-- ![](images/img-Windows 调试工具课程91.png) -->
![](images/img-modify-953b06593c848325f1e451cc8283d210.jpg)
...
<!-- ![](images/img-Windows 调试工具课程92.png) -->
![](images/img-modify-eef4067873674d3063e7f0397b7aa5d6.jpg)
...
<!-- ![](images/img-Windows 调试工具课程93.png) -->
...
<!-- ![](images/img-Windows 调试工具课程94.png) -->
...
<!-- ![](images/img-Windows 调试工具课程95.png) -->
...
<!-- ![](images/img-Windows 调试工具课程96.png) -->
