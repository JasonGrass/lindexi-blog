...
pubDatetime: 2024-01-27 01:59:41
modDatetime: 2024-08-06 12:43:29
slug: dotnet-使用-MSTestRunner-将单元测试制作为独立可执行文件
description: "dotnet 使用 MSTestRunner 将单元测试制作为独立可执行文件"
tags:
  - dotnet
---
...
<!-- ![](images/img-dotnet 使用 MSTestRunner 将单元测试制作为独立可执行文件0.png) -->
![](images/img-modify-a31967427e79bcf756af10d8e3caa652.jpg)
