---
title: "win32 低内存通知事件"
pubDatetime: 2024-06-22 23:07:41
modDatetime: 2024-08-06 12:43:39
slug: win32-低内存通知事件
description: "win32 低内存通知事件"
---
...
<!-- ![](images/img-win32 低内存通知事件0.png) -->
![](images/img-modify-d3d64f3489be4a0334cc1ae1e3e073ec.jpg)

双击即可看到对应的对象产生了多少句柄和引用

如果想要了解系统中有哪些进程请求了内存资源通知，可以使用 Process Explorer 的 Find 菜单进行搜索句柄表，如下图

<!-- ![](images/img-win32 低内存通知事件1.png) -->
![](images/img-modify-f4906b256268253fd9e2275e37b8bcd5.jpg)
