...
pubDatetime: 2024-06-17 23:15:33
modDatetime: 2024-06-17 23:15:33
slug: dotnet-C-使用-using-关键字释放-IDisposable-的结构体是否会装箱
description: "dotnet C# 使用 using 关键字释放 IDisposable 的结构体是否会装箱"
tags:
  - dotnet
  - C#
---
