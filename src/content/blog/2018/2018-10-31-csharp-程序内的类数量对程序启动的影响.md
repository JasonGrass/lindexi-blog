...
pubDatetime: 2018-10-31 06:07:06
modDatetime: 2025-12-28 07:46:05
slug: C-程序内的类数量对程序启动的影响
description: "C# 程序内的类数量对程序启动的影响"
tags:
  - C#
  - 性能测试
---
...
<!-- ![](images/img-C# 程序内的类数量对程序启动的影响0.png) -->

![](images/img-modify-ee50ecdf3ce1dfe50b928530dfb5ceb5.png)

附加调试可以看到运行的时间都不是自己写的代码的时间，总时间是 138ms 实际运行的时间会比这个少。每个人的设备测试的时间都会不相同，而且每个时间运行的值都不太一样

<!-- ![](images/img-C# 程序内的类数量对程序启动的影响1.png) -->

![](images/img-modify-038d1f3d88b977b3c76782de5f5d9a61.png)
...
<!-- ![](images/img-C# 程序内的类数量对程序启动的影响2.png) -->

![](images/img-modify-6e0300f8c5e03e5194780c6585eec9f0.png)
...
<!-- ![](images/img-C# 程序内的类数量对程序启动的影响3.png) -->

![](images/img-modify-c78ec4d928237638c03fc65380f5779b.png)
