...
slug: C-配置文件存储-各种序列化算法性能比较
description: "C# 配置文件存储 各种序列化算法性能比较"
tags:
  - C#
---
...
![](images/img-modify-ec31ef845c2f7f10800089173d98b24c.jpg)
...
![](images/img-modify-36ebcac0432f1f3b817e27530c3358a0.jpg)

<!-- ![](images/img-C# 配置文件存储 各种序列化算法性能比较0.png) -->
