...
slug: win10-uwp-App-to-app-communication-应用通信
description: "win10 uwp App-to-app communication 应用通信"
tags:
  - Win10
  - UWP
---
...
![](images/img-70888377.jpg)

![](images/img-65763757.jpg)
我们在说明写：林德熙博客

但说明其实没有什么用，主要是数据格式才是需要我们选择，在上也看到我们可以分享的数据有多种格式，那么满足格式的分享就会在分享看到我们的应用。

![](images/img-25742257.jpg)
