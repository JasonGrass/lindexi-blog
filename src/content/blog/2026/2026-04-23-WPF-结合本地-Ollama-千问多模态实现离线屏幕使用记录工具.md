...
pubDatetime: 2026-04-23 12:11:14
modDatetime: 2026-04-23 12:24:56
slug: WPF-结合本地-Ollama-千问多模态实现离线屏幕使用记录工具
description: "WPF 结合本地 Ollama 千问多模态实现离线屏幕使用记录工具"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 结合本地 Ollama 千问多模态实现离线屏幕使用记录工具0.png) -->
![](images/img-lindexi-20264232024505792.jpg)
