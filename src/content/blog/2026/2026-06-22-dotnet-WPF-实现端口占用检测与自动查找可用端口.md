...
pubDatetime: 2026-06-22 00:24:37
modDatetime: 2026-06-22 06:23:05
slug: dotnet-WPF-实现端口占用检测与自动查找可用端口
description: "dotnet WPF 实现端口占用检测与自动查找可用端口"
tags:
  - WPF
  - dotnet
---
...
<!-- ![](images/img-dotnet WPF 实现端口占用检测与自动查找可用端口0.png) -->
![](images/img-lindexi-2026622832339865.jpg)
...
<!-- ![](images/img-dotnet WPF 实现端口占用检测与自动查找可用端口1.png) -->
![](images/img-lindexi-2026622834244980.jpg)
