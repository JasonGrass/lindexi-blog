...
modDatetime: 2026-02-25 23:13:28
...
<!-- ![](images/img-dotnet DirectX 通过可等待交换链降低输入渲染延迟0.png) -->
![](images/img-lindexi-2026225103996975.jpg)

第二张图如下，这是在使用 Windows 8.1 引入的 `DXGI_SWAP_CHAIN_FLAG_FRAME_LATENCY_WAITABLE_OBJECT` 可等待交换链技术的情况下，轻松地让输入的响应在第 3 帧渲染出来

<!-- ![](images/img-dotnet DirectX 通过可等待交换链降低输入渲染延迟1.png) -->
![](images/img-lindexi-20262251040381004.jpg)
