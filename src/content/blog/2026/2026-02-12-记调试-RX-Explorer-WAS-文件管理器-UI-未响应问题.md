...
pubDatetime: 2026-02-11 23:10:34
modDatetime: 2026-02-12 00:40:13
slug: 记调试-RX-Explorer-WAS-文件管理器-UI-未响应问题
description: "记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题"
---
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题0.png) -->
![](images/img-lindexi-2026211144721449.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题1.png) -->
![](images/img-lindexi-20262111449374487.jpg)

遇到这类未响应问题，优先勾选托管代码调试，附带加上托管（本机编译）选项，不先勾选本机调试。这样做的原因是大部分情况下，可以通过托管代码快速定位到卡住的问题，无需挂载本机调试来干扰调试

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题2.png) -->
![](images/img-lindexi-20262111452175937.jpg)

挂进去之后，现在的进程还在正常跑着，点一下暂停，看看 UI 主线程卡在哪里了

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题3.png) -->
![](images/img-lindexi-20262111453495178.jpg)

这个时候我习惯让 Visual Studio 的调试界面布局为一边为调用堆栈，一边为线程。如此可以快速切线程来查看各个线程当前所在的堆栈情况。通过 Visual Studio 的 调试->窗口 选项里面，可以打开调用堆栈、线程等窗口

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题4.png) -->
![](images/img-lindexi-20262111456126627.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题5.png) -->
![](images/img-lindexi-2026211153252049.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题6.png) -->
![](images/img-lindexi-2026211155321079.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题7.png) -->
![](images/img-lindexi-2026211158166216.jpg)

此时附加过程中出现了一个调试异常，如下图所示，忽略即可，忽略方法就是点击继续运行

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题8.png) -->
![](images/img-lindexi-2026211159283214.jpg)

再次点击暂停，看看这一次的主线程堆栈

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题9.png) -->
![](images/img-lindexi-20262111510143168.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题10.png) -->
![](images/img-lindexi-20262111515549703.jpg)

再次附加调试就看到了 CoreCLR 发起加载程序集的堆栈了

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题11.png) -->
![](images/img-lindexi-20262111517296875.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题12.png) -->
![](images/img-lindexi-20262111520103316.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题13.png) -->
![](images/img-lindexi-2026211154314926.jpg)

此时就能看到主线程卡住的核心原因就是因为存在一个线程在加载 DLL 的过程中卡住，如下图所示。注：下图是后面截的，导致线程号和后文的不匹配，还请大家略过

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题17.png) -->
![](images/img-lindexi-2026211161251696.jpg)

切换到对应的线程，查看堆栈，可以看到确实是正在加载 DLL 的过程中

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题14.png) -->
![](images/img-lindexi-20262111544401942.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题15.png) -->
![](images/img-lindexi-2026211154818324.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题16.png) -->
![](images/img-lindexi-20262111550123038.jpg)
...
<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题19.png) -->
![](images/img-lindexi-2026211167206398.jpg)

通过 <https://www.nirsoft.net/utils/shexview.html> 提供的 ShellView 工具干掉百度云右键菜单

<!-- ![](images/img-记调试 RX-Explorer-WAS 文件管理器 UI 未响应问题18.png) -->
![](images/img-lindexi-2026211165585828.jpg)
