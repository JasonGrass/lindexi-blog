...
pubDatetime: 2021-03-03 13:05:47
modDatetime: 2024-08-06 12:43:40
slug: WPF-基础-2D-图形学知识-判断点是否在任意几何内部方法
description: "WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法"
tags:
  - WPF
---
...
<!-- ![](images/img-判断点在几何内.gif) -->

![](images/img-lindexi%2F%25E5%2588%25A4%25E6%2596%25AD%25E7%2582%25B9%-modify-4756ab6ad4a75250e8593ceccbe9a29e.gif)
...
<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法0.png) -->

![](images/img-lindexi%2F2021332113414181.jpg)

按照任意方向将几何的相邻的点连接作为向量，此时可以发现如果点在几何内，那么点就在这些向量的相同的一边

<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法1.png) -->

对于二维的向量，点和向量只有三个关系，要么在向量的方向上，要么就在向量的两边。如下图，用不同的颜色表示三个不同的关系

<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法2.png) -->

![](images/img-lindexi%2F2021332117294523.jpg)

当然了，向量自己本身就有方向，如下图，两个方向相反的向量，此时的点对于两个向量来说都在相同的方向

<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法3.png) -->

![](images/img-lindexi%2F202133211877283.jpg)

其实看到下面的动态图片就能更好的理解，如果绕点进行旋转让这两个向量方向相同，此时可以看到对于两个向量来说，点都在相同的方向

<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法.gif) -->

![](images/img-lindexi%2FWPF%2520%25E5%259F%25BA%25E7%25A1%2580%25202D%-modify-3d61f8cf93fac6959fd256c66cd628ee.gif)

如何判断点在向量的某个方向？其实相当于判断两个向量的夹角，如下图，同时取几何相邻点以及与需要判断的点分别做两个向量，可以求出两个向量之间的夹角

<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法4.png) -->

![](images/img-lindexi%2F202134840407076.jpg)

而咱为了性能考虑，不会真的求向量的夹角的值来判断。因为向量的夹角的值，可以看到有两个方向的值，一个是小于 180 度的，另一个是大于 180 度的

<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法5.png) -->

![](images/img-lindexi%2F20213484455875.jpg)
...
<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法1.gif) -->

![](images/img-lindexi%2FWPF%2520%25E5%259F%25BA%25E7%25A1%2580%25202D%-modify-a6148b0fc77b2a004cffbb5bc0511bbc.gif)
...
<!-- ![](images/img-WPF 基础 2D 图形学知识 判断点是否在任意几何内部方法6.png) -->

![](images/img-lindexi%2FWPF%2520%25E5%259F%25BA%25E7%25A1%2580%25202D%-modify-a3d0bb5b23a67f2ccd1f0154b71a9744.png)
...
<!-- ![](images/img-WPF 基础 2D 图形学知识1.png) -->

![](images/img-lindexi%2F20211272028498690.jpg)
...
<!-- ![](images/img-WPF 基础 2D 图形学知识2.png) -->

![](images/img-lindexi%2F2021127204044398.jpg)

定义的向量如下

<!-- ![](images/img-WPF 基础 2D 图形学知识3.png) -->

![](images/img-lindexi%2F20211272042302440.jpg)
...
<!-- ![](images/img-WPF 基础 2D 图形学知识4.png) -->

![](images/img-lindexi%2F2021127204705505.jpg)

从图片可以看到所有的向量都从 A 点出发，此时可以将 A 点设置为原点，如果此时的 M 是在矩形外，如认为是在如下图的左边，那么此时向量相乘的值就会是负数，因为相对于 A 作为原点

<!-- ![](images/img-WPF 基础 2D 图形学知识5.png) -->

![](images/img-lindexi%2F2021127204956927.jpg)

因此小于零的就不在矩形内，这就是旋转之前水平方向的判断 `0<AM⋅AB` 的依据

而如果 `AB⋅AB` 就表示 AB 的向量长度，也就是说如果 AM 的距离实际上大于 AB 的距离，如点在矩形的右边，那么点也不在矩形内

<!-- ![](images/img-WPF 基础 2D 图形学知识6.png) -->

![](images/img-lindexi%2F2021127205388240.jpg)
