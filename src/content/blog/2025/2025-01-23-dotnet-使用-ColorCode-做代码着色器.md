...
<!-- ![](images/img-dotnet 使用 ColorCode 做代码着色器0.png) -->
![](images/img-modify-823d0a4e2bb7857bc05491eddbd9ba7a.jpg)

以下为 Avalonia 版本的效果图

<!-- ![](images/img-dotnet 使用 ColorCode 做代码着色器1.png) -->
![](images/img-modify-9e1e29aa3097e8b763654e75114f39c7.jpg)
