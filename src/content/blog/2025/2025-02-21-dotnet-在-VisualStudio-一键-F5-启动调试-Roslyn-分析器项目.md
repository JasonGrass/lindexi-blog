...
<!-- ![](images/img-dotnet 在 VisualStudio 一键 F5 启动调试 Roslyn 分析器项目1.png) -->
...
<!-- ![](images/img-dotnet 在 VisualStudio 一键 F5 启动调试 Roslyn 分析器项目2.png) -->
![](images/img-modify-e1f0aade39ae8e8bb21bbc618f35db4a.jpg)

愉快点击下拉菜单，选择要调试项目即可，如下图所示

<!-- ![](images/img-dotnet 在 VisualStudio 一键 F5 启动调试 Roslyn 分析器项目3.png) -->
![](images/img-modify-92e85ed040bab26899c93ee11024bca7.jpg)

选中之后的效果如下图所示

<!-- ![](images/img-dotnet 在 VisualStudio 一键 F5 启动调试 Roslyn 分析器项目4.png) -->
...
<!-- ![](images/img-dotnet 在 VisualStudio 一键 F5 启动调试 Roslyn 分析器项目5.png) -->
![](images/img-modify-053760bd3865a11585879cc6297daffd.jpg)
...
<!-- ![](images/img-dotnet 在 VisualStudio 一键 F5 启动调试 Roslyn 分析器项目6.png) -->
![](images/img-modify-a82180d2c7799165b9273ef8ba08cf29.jpg)
