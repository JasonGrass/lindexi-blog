---
title: "Avalonia 界面效果 三个圆实现模糊界面动效背景"
pubDatetime: 2025-03-31 12:16:08
modDatetime: 2025-03-31 12:52:31
slug: Avalonia-界面效果-三个圆实现模糊界面动效背景
description: "Avalonia 界面效果 三个圆实现模糊界面动效背景"
tags:
  - Avalonia
---
...
<!-- ![](images/img-Avalonia 界面效果 三个圆实现模糊界面动效背景0.gif) -->
![](images/img-modify-aef73fbd61728b28d2616fd78e6d30d0.gif)

实现原理非常简单，就是构建出三个圆形，三个圆形的大小不相同，然后让其做绕圈动画。最后叠加上模糊效果即可

<!-- ![](images/img-Avalonia 界面效果 三个圆实现模糊界面动效背景1.gif) -->
![](images/img-modify-279c5755839dbefae706eee0a44b84e6.gif)
