...
<!-- ![](images/img-WPF 警惕 StylusPlugIn 的多线程安全问题0.png) -->
![](images/img-lindexi-20259101949262527.jpg)

一路追踪堆栈，可见这是从主线程的鼠标消息进入触发的，如下图所示

<!-- ![](images/img-WPF 警惕 StylusPlugIn 的多线程安全问题1.png) -->
![](images/img-lindexi-20259101951104907.jpg)
