...
pubDatetime: 2025-08-21 00:48:46
modDatetime: 2025-08-21 00:48:46
slug: WPF-引用-ASP.NET-Core-的-AOT-版本
description: "WPF 引用 ASP.NET Core 的 AOT 版本"
tags:
  - WPF
  - ASP.NETCore
---
...
<!-- ![](images/img-WPF 引用 ASP.NET Core 的 AOT 版本2.png) -->
![](images/img-lindexi-2025820203486781.jpg)
...
<!-- ![](images/img-WPF 引用 ASP.NET Core 的 AOT 版本0.png) -->
![](images/img-lindexi-20258201959537134.jpg)

点击按钮，更新一下文本内容，再次发送 http 请求，可见如下界面

<!-- ![](images/img-WPF 引用 ASP.NET Core 的 AOT 版本1.png) -->
![](images/img-lindexi-2025820204196666.jpg)
