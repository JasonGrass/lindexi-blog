...
pubDatetime: 2025-04-08 23:25:55
modDatetime: 2025-04-08 23:25:55
slug: WPF-探索-Skia-的竖排文本渲染的字符高度
description: "WPF 探索 Skia 的竖排文本渲染的字符高度"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度0.png) -->
![](images/img-modify-fa862e47ddf97555e2511b0dd2e1e3a8.jpg)
...
<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度1.png) -->
![](images/img-modify-5bb8f3446281cdde0e04bb07ca07dbb2.jpg)
...
<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度2.png) -->
![](images/img-modify-8d4d12c505eb68f520ef0e4e5e0dec0f.jpg)
...
<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度3.png) -->
![](images/img-modify-fffd12f6dc27e0022423e9830b9527f2.jpg)
...
<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度4.png) -->
![](images/img-modify-a3f28d31475e354f65d152a42cec9b7a.jpg)

只引入 baseline 依然还是不够的，为了能够在竖排过程中，让一些汉字，如“一”进行垂直方向的居中，这里不会直接从 baseline 开始画，而是取 `(baseline-space/2)` 开始画，确保画出来的效果如下所示

<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度5.png) -->
![](images/img-modify-0d30a91edd3c574382dfd90928907b7d.jpg)
...
<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度6.png) -->
![](images/img-modify-579ad8da15a35ce6f3c0c81117602c33.jpg)

去掉调试边框之后的效果如下

<!-- ![](images/img-WPF 探索 Skia 的竖排文本渲染的字符高度7.png) -->
![](images/img-modify-a0f4e8a0e6c9d4a6c5d5e1096e37106b.jpg)
