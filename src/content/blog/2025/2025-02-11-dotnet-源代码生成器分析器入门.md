...
modDatetime: 2025-11-06 22:25:39
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门12.png) -->
![](images/img-modify-64f0668e53b325356537f7fbef1b1dbe.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门7.png) -->
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门8.png) -->
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门9.png) -->
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门0.png) -->
![](images/img-modify-1a7799ab1f9e04537b8692efeefcbea6.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门1.png) -->
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门2.png) -->
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门3.png) -->
![](images/img-modify-fece87153f05a08c72f4ba9933d24cac.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门4.png) -->
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门6.png) -->
![](images/img-modify-cca9935c33ab647ee5a28933fa357290.jpg)

其界面大概如下

<!-- ![](images/img-dotnet 源代码生成器分析器入门5.png) -->
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门15.png) -->
![](images/img-modify-d4016284f17f7cbc40f6ff2ce4b33af8.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门13.png) -->
![](images/img-modify-abd1829653ed4aeb04fdaabdc0403554.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门14.png) -->
![](images/img-modify-16067deb5c9d5f7f917316af11e33d36.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门18.png) -->
![](images/img-modify-cbe68b5b7fc57eb1be5db5819a2f7837.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门19.png) -->
![](images/img-modify-17957ef411a22b2eaef0847393038b3f.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门20.png) -->
![](images/img-modify-76f04e56fd1631937aa9f1e3578e85a8.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门21.png) -->
![](images/img-modify-b6dfbcfe8930f6db5aac97a594b88231.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门22.png) -->
![](images/img-modify-77478d05489356e430c3c989f185adda.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门23.png) -->
![](images/img-modify-f2d274800f08051e8c7876437a40349f.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门24.png) -->
![](images/img-modify-34e2aa208cf45ab9aba728bc9b0f3208.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门27.png) -->
![](images/img-modify-63eaa20c0e664b16fddc71451cee0a1a.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门26.png) -->
![](images/img-modify-c706ab156eb34aeccd50996045a9f881.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门25.png) -->
![](images/img-modify-728467904e32890d9d3b0c64f065295b.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门29.png) -->
![](images/img-modify-dc006446157969be84ef5495291657d5.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门28.png) -->
![](images/img-modify-94ced8d457ad075504fa79cd671e163a.jpg)

通过本演练的源代码生成器所处理之后，通过 ILSpy 工具查看生成的 dll 文件，可见最终的生成代码是调用了 FooInterceptor 的三个生成的方法，完全不是静态代码所见的调用 `Foo` 类型的 `WriteLine` 方法

<!-- ![](images/img-dotnet 源代码生成器分析器入门30.png) -->
![](images/img-modify-770fb6d64d4a13e0a5dd995e44d07949.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门31.png) -->
![](images/img-modify-af9460cf1a40a28cbebe6dcb0a32d987.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门17.png) -->
![](images/img-modify-4e1b847e46d5ee1127fad5ee423fc07e.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门16.png) -->
![](images/img-modify-ab46b8678c4e454030960dd767df26da.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门33.png) -->
![](images/img-modify-17f9c9c84b67d74a5d97178edf5431fb.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门34.png) -->
![](images/img-modify-b2985738ab809bc73410d9f86762409f.jpg)
...
<!-- ![](images/img-dotnet 源代码生成器分析器入门32.png) -->
![](images/img-modify-d708688da20272c2b7230a9a7e3c5dbd.jpg)
