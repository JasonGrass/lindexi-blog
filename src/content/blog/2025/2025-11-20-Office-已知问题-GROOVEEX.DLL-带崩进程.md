...
<!-- ![](images/img-Office 已知问题 GROOVEEX.DLL 带崩进程3.png) -->
![](images/img-lindexi-202511191058416015.jpg)

可见进程崩溃的原因是 “该线程尝试读写某个虚拟地址，而它对该地址不具有相应的访问权限” 导致的，如下图所示

<!-- ![](images/img-Office 已知问题 GROOVEEX.DLL 带崩进程2.png) -->
![](images/img-lindexi-202511191058515413.jpg)
...
<!-- ![](images/img-Office 已知问题 GROOVEEX.DLL 带崩进程4.png) -->
![](images/img-lindexi-20251119110237495.jpg)

出现问题的 GROOVEEX.DLL 文件的版本是 16.0.19509.20000

<!-- ![](images/img-Office 已知问题 GROOVEEX.DLL 带崩进程0.png) -->
![](images/img-lindexi-202511191056291741.jpg)

查看签名文件确实是微软的签名，预计就是软软写错了什么代码导致的问题

<!-- ![](images/img-Office 已知问题 GROOVEEX.DLL 带崩进程1.png) -->
![](images/img-lindexi-202511191057149045.jpg)
