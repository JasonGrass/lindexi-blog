...
modDatetime: 2025-04-27 00:54:14
...
<!-- ![](images/img-dotnet 9 通过 AppHostRelativeDotNet 指定自定义的运行时路径0.png) -->
![](images/img-modify-d5e57c97779a3e0ac77a0fba69c92c38.jpg)
...
<!-- ![](images/img-dotnet 9 通过 AppHostRelativeDotNet 指定自定义的运行时路径1.png) -->
...
<!-- ![](images/img-dotnet 9 通过 AppHostRelativeDotNet 指定自定义的运行时路径2.png) -->
...
<!-- ![](images/img-dotnet 9 通过 AppHostRelativeDotNet 指定自定义的运行时路径3.png) -->
...
<!-- ![](images/img-dotnet 9 通过 AppHostRelativeDotNet 指定自定义的运行时路径4.png) -->
![](images/img-modify-ab0292457ab1ddaef3f00c914521fcb6.jpg)

下载下来的是一个 zip 压缩包，打开压缩包就可以看到这就是上文提到的 `relative/path/to/runtime` 文件夹内的结构，按照本文提供的方式将其解压缩就好了

<!-- ![](images/img-dotnet 9 通过 AppHostRelativeDotNet 指定自定义的运行时路径5.png) -->
