...
pubDatetime: 2019-11-29 02:20:01
modDatetime: 2024-08-06 12:43:29
slug: dotnet-remoting-使用事件
description: "dotnet remoting 使用事件"
tags:
  - .net
  - remoting
  - rpc
...
<!-- ![](images/img-.net remoting 使用事件1.png) -->

![](images/img-5b6979c41dcd6.jpg)

这时需要先将这几个类都移动到一个新项目，然后右击这个项目属性生成，让生成序列化程序集为开

<!-- ![](images/img-.net remoting 使用事件0.png) -->

![](images/img-5b694bf6020c8.jpg)
