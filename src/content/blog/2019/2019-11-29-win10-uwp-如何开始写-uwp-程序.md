...
pubDatetime: 2019-11-29 02:12:42
modDatetime: 2026-01-26 09:46:19
slug: win10-uwp-如何开始写-uwp-程序
description: "win10 uwp 如何开始写 uwp 程序"
tags:
  - Win10
  - UWP
---
...
![](images/img-modify-d16d300cf42a8b8431f82ab6474e3f0a.jpg)
...
![](images/img-modify-8350e07278639900fef2cf3845c0883c.jpg)

点击空白项目就可以创建，记得设置软件名和解决方案名，存放的位置。

点击确定就可以看到下面的界面

![](images/img-modify-a5c4297b56c53e078543347452629d1d.jpg)

需要注意，目标版本就是当前编译面对的版本，但是最低版本指的是需要支持的版本。

如果选择的目标版本越高，理论可以使用的接口越多，如果选择的最低版本很低，那么就必须使用越低的接口。

![](images/img-modify-0f84fb5f18e65c3f0e0cc49c813dca36.jpg)
...
![](images/img-modify-84c76c6aa591e2d724549d589d3b8b8b.jpg)
...
![](images/img-modify-4a89a9967c64b4a7856b01d0ff1930c0.jpg)

然后可以看到这个界面

![](images/img-modify-32ed275b7b1748e38c7a1745a3274e37.jpg)
