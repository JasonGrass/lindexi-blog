...
pubDatetime: 2019-04-29 01:42:02
modDatetime: 2024-08-06 12:43:41
slug: WPF-如何判断一个控件在滚动条的里面是用户可见
description: "WPF 如何判断一个控件在滚动条的里面是用户可见"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 如何判断一个控件在滚动条的里面是用户可见0.png) -->

![](images/img-modify-67ecea2f950f61054fe8d2f96cca2ef2.png)
...
<!-- ![](images/img-WPF 如何判断一个控件在滚动条的里面是用户可见1.png) -->

![](images/img-modify-a3631b2f9d3a75eef448771906f99114.png)
