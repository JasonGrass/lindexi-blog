---
title: "WPF 触摸到事件"
pubDatetime: 2019-06-15 00:58:54
modDatetime: 2024-09-09 09:38:58
slug: WPF-触摸到事件
description: "WPF 触摸到事件"
tags:
  - WPF
  - 触摸
  - 源代码分析
...
<!-- ![](images/img-WPF 触摸到事件11.png) -->

![](images/img-modify-0255acf4a9c665ed068fc47d955ace86.png)

在触摸线程各个模块的关系请看下面

<!-- ![](images/img-WPF 触摸到事件12.png) -->

![](images/img-modify-45bdcd26120bdb79a3c122faace364b4.png)

从触摸线程转换到主线程，然后从主线程封装为路由事件的模块请看下面

<!-- ![](images/img-WPF 触摸到事件13.png) -->

![](images/img-modify-9f325e7413ed1c86496ad05d335fb0f3.png)

路由事件需要封装触摸消息并且找到命中的元素

<!-- ![](images/img-WPF 触摸到事件14.png) -->

![](images/img-modify-fe8d29bd89cac9eb5e06e2a862d1daa7.png)
...
<!-- ![](images/img-WPF 触摸到事件5.png) -->

![](images/img-modify-5e3c92a1b65a04b3c3d74f2f5b0d6bfa.png)
...
<!-- ![](images/img-WPF 触摸到事件2.png) -->

![](images/img-modify-eae0180a15d8247613b486cee065e4eb.png)
...
<!-- ![](images/img-WPF 触摸到事件3.png) -->

![](images/img-modify-ba444fb9e7a7e9e94ef779d7b1856073.png)
...
<!-- ![](images/img-WPF 触摸到事件6.png) -->

![](images/img-modify-8a67dd72e28a936e771db56b212d0bde.png)
...
<!-- ![](images/img-WPF 触摸到事件7.png) -->

![](images/img-modify-40579d13aab7b17b75568e01a93dae16.png)

主线程从 `_dlgInputManagerProcessInput` 就是调用 `InputManagerProcessInput` 方法，是使用出队的方式拿到触摸线程的触摸。上面的图片写了入栈实际上是入队。

<!-- ![](images/img-WPF 触摸到事件9.png) -->

![](images/img-modify-d64b2a85661e9072e45c677fd09ed234.png)
...
<!-- ![](images/img-WPF 触摸到事件8.png) -->

![](images/img-modify-d6ebece81c00a37c80e4ff4edecb1507.png)
...
<!-- ![](images/img-WPF 触摸到事件10.png) -->

![](images/img-modify-c66df8024f1f5acccb9e01924778ebb7.png)
...
<!-- ![](images/img-WPF 触摸到事件0.png) -->

![](images/img-modify-1fbcbaaaeeffb7bb27f7c63153fc853e.png)
...
<!-- ![](images/img-WPF 触摸到事件1.png) -->

![](images/img-modify-17c987ce8537f40e2cd1e8387aabb176.png)
