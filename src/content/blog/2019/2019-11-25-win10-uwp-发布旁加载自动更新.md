...
pubDatetime: 2019-11-25 07:45:47
modDatetime: 2024-08-06 12:43:36
slug: win10-uwp-发布旁加载自动更新
description: "win10 uwp 发布旁加载自动更新"
tags:
  - Win10
  - UWP
---
...
<!-- ![](images/img-win10 uwp 发布旁加载自动更新1.png) -->

![](images/img-modify-f50b19ef91f228a7cd33fdbb2927a0ff.png)
...
<!-- ![](images/img-win10 uwp 发布旁加载自动更新2.png) -->

![](images/img-modify-fdccb3279e62798bdc8522d603f60cab.png)

这里只是做演示，所以只勾选 x86 的，这样创建速度比较快

<!-- ![](images/img-win10 uwp 发布旁加载自动更新3.png) -->

![](images/img-modify-a7572768ea904ba9d71f8029814d39ae.png)

点击下一步，在这里写入 URL 这里需要拿到本地的内网的 IP 这样在可以在后面在其他的设备安装 UWP 应用，我这里已经写上了自己的 IP 和端口号，还有一个路径

<!-- ![](images/img-win10 uwp 发布旁加载自动更新11.png) -->

![](images/img-modify-193fc4bc2a941699999424f7f8041217.png)
...
<!-- ![](images/img-win10 uwp 发布旁加载自动更新4.png) -->

![](images/img-modify-7e2129d55c0717de861ce5a5b9a33d5b.png)
...
<!-- ![](images/img-win10 uwp 发布旁加载自动更新5.png) -->

![](images/img-modify-d26a1d8aae6f4d9984263b87daee680a.png)
...
<!-- ![](images/img-win10 uwp 发布旁加载自动更新6.png) -->

![](images/img-modify-c6054d9f3e28212836dd8715cc646b76.png)

因为他需要先下载证书，在使用旁加载就需要手动安装证书，因为测试程序使用的证书是不可信的，点击其他链接，下载证书

<!-- ![](images/img-win10 uwp 发布旁加载自动更新7.png) -->

![](images/img-modify-4c94753961d8c8f05147a047ea94f790.png)

打开证书，然后点击安装证书，选放在本地计算机

<!-- ![](images/img-win10 uwp 发布旁加载自动更新8.png) -->

![](images/img-modify-696e4256262b3cf2be6ea04861390bb7.png)

然后点击将所有的证书放在受信任的根证书颁发

<!-- ![](images/img-win10 uwp 发布旁加载自动更新9.png) -->

![](images/img-modify-33b35ca087c5983e98e98c0e5942c604.png)

点击完成

<!-- ![](images/img-win10 uwp 发布旁加载自动更新10.png) -->

![](images/img-modify-520ea966a904c6c85329ae0aebf20d1c.png)

现在点击获取应用，等待安装，现在就可以看到下面界面

<!-- ![](images/img-win10 uwp 发布旁加载自动更新0.png) -->

![](images/img-modify-f929b13f769f5b03390d382747b938a8.png)
...
<!-- ![](images/img-win10 uwp 发布旁加载自动更新12.png) -->

![](images/img-modify-a572c34d636a323d3d5efb4b3b834ad0.png)
