---
title: "WPF 渲染原理"
pubDatetime: 2019-09-08 02:40:00
modDatetime: 2025-01-09 08:33:36
slug: WPF-渲染原理
description: "WPF 渲染原理"
tags:
  - WPF
  - 渲染
---
...
![](images/img-modify-2d2936bc3cbd194bcbe635e3dcc69434.jpg)
...
![](images/img-modify-016a09fbf2ac198609fa1a16e98d04c6.jpg)
...
<!-- ![](images/img-WPF 渲染原理4.png) -->

![](images/img-modify-3836eb303a532db32804b30a62ae9f76.png)
...
<!-- ![](images/img-WPF 渲染原理5.png) -->

![](images/img-modify-f3e9aee34c1e4cc1a3378d6a551a0477.png)

最核心的处理消息就是 Dispatcher 的 WndProcHook 这个方法实际上只是调用 ProcessQueue 方法。

<!-- ![](images/img-WPF 渲染原理6.png) -->

![](images/img-modify-8014c9e15a2e7a8fd044394b6aff5e8f.png)
...
<!-- ![](images/img-WPF 渲染原理7.png) -->

![](images/img-modify-b47d46435088040e83435d5de084dde9.png)
...
<!-- ![](images/img-WPF 渲染原理9.png) -->

![](images/img-modify-fa271b04520d7105f4f6fd21baba0512.png)
...
<!-- ![](images/img-WPF 渲染原理8.png) -->

![](images/img-modify-92bcbb3a073ee54bc8f38ee632a742ff.png)
...
<!-- ![](images/img-WPF 渲染原理10.png) -->

![](images/img-modify-257f306b294a9154f696a7dc4096a739.png)
...
<!-- ![](images/img-WPF 渲染原理11.png) -->

![](images/img-modify-3ccc2b3a9cf09e12d10df4d96e9b69b1.png)

在绘制的时候需要使用 MIL 解码一些图片和一些形状才可以用到 dx 进行渲染

<!-- ![](images/img-WPF 渲染原理12.png) -->

![](images/img-modify-164d6096b3a76a485fdfa36fc012e742.png)
...
<!-- ![](images/img-WPF 渲染原理13.png) -->

![](images/img-modify-9a9058b45ebad392d3bcf653058ca0aa.png)
...
<!-- ![](images/img-WPF 渲染原理0.png) -->

![](images/img-modify-3a0f3fd5a8e0abb613347b454dd08dae.png)

在 Dispatcher 收到消息之后就可以把渲染任务放在队列，按照优先级一个个出队

<!-- ![](images/img-WPF 渲染原理1.png) -->

![](images/img-modify-b5e85482e24e262c920db8efbd10ebaa.png)
...
<!-- ![](images/img-WPF 渲染原理2.png) -->

![](images/img-modify-904a062e63a9b997ee726b36fbe52f36.png)

总的渲染结构请看下图

<!-- ![](images/img-WPF 渲染原理3.png) -->

![](images/img-modify-d4eb6d888048d3c2d6201be76f995d76.png)
