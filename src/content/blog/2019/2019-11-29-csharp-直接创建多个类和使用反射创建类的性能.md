...
pubDatetime: 2019-11-29 02:13:14
modDatetime: 2026-01-26 09:36:32
slug: C-直接创建多个类和使用反射创建类的性能
description: "C# 直接创建多个类和使用反射创建类的性能"
tags:
  - C#
  - 性能测试
---
...
<!-- ![](images/img-C# 直接创建多个类和使用反射创建类的性能1.png) -->

![](images/img-modify-e9f33e4cdaaf2692fc9672220d59d317.png)
...
<!-- ![](images/img-C# 直接创建多个类和使用反射创建类的性能0.png) -->

![](images/img-modify-6edda88a3ceea2169bc3ae538790eb40.png)
