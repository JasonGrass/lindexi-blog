...
pubDatetime: 2019-11-29 00:50:02
modDatetime: 2024-08-06 12:43:41
slug: WPF-客户端开发需要知道的触摸失效问题
description: "WPF 客户端开发需要知道的触摸失效问题"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 客户端开发需要知道的触摸失效问题0.png) -->

![](images/img-TcfeyxFhKSoia3Z.jpg)
...
<!-- ![](images/img-WPF 客户端开发需要知道的触摸失效问题1.png) -->

![](images/img-modify-c029ffc6cceab555f0f697a1e793f82d.png)
...
<!-- ![](images/img-WPF 客户端开发需要知道的触摸失效问题2.png) -->

![](images/img-modify-9a1e0a424d8e6e9d3d851e8b706c0c90.png)

<!-- ![](images/img-WPF 客户端开发需要知道的触摸失效问题3.png) -->

![](images/img-modify-44080496e80408dabcfbd27a433bc4fb.png)


<!-- ![](images/img-WPF 客户端开发需要知道的触摸失效问题4.png) -->

![](images/img-modify-0da8604b069873ce112c63a9c1e40369.png)

<!-- ![](images/img-WPF 客户端开发需要知道的触摸失效问题5.png) -->

![](images/img-modify-6790062d1ca8f3096681ee694ea85dec.png)
...
基本上应用触摸失效，同时在启动过程就触摸失效的，都是win7的系统。现在win10的触摸架构修改了，很少有用户告诉我触摸失效。也许可以考虑在应用里面接入重启触摸模块来解决大部分的触摸失效问题，包括在 Win7 系统的触摸失效，接入方法参阅 [WPF 触摸失效 试试重启触摸](https://blog.lindexi.com/post/WPF-%E8%A7%A6%E6%91%B8%E5%A4%B1%E6%95%88-%E8%AF%95%E8%AF%95%E9%87%8D%E5%90%AF%E8%A7%A6%E6%91%B8.html )

另外，有可能是触摸冲突的问题，被其他软件冲突了等，或者是触摸屏占用问题，如有屏幕上有某个点持续在按下触摸等。这些都可以尝试使用开启 Pointer 的方式解决，依赖 Pointer 的触摸架构变更的行为变更处理此问题。开启 Pointer 方法请参阅 [win10 支持默认把触摸提升 Pointer 消息](https://blog.lindexi.com/post/win10-%E6%94%AF%E6%8C%81%E9%BB%98%E8%AE%A4%E6%8A%8A%E8%A7%A6%E6%91%B8%E6%8F%90%E5%8D%87-Pointer-%E6%B6%88%E6%81%AF.html ) 而关于开启 Pointer 的已知问题请参阅 [WPF 开启Pointer消息存在的坑](https://blog.lindexi.com/post/WPF-%E5%BC%80%E5%90%AFPointer%E6%B6%88%E6%81%AF%E5%AD%98%E5%9C%A8%E7%9A%84%E5%9D%91.html )
