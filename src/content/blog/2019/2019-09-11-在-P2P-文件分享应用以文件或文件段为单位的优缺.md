...
pubDatetime: 2019-09-11 02:23:27
modDatetime: 2024-08-06 12:43:44
slug: 在-P2P-文件分享应用以文件或文件段为单位的优缺
description: "在 P2P 文件分享应用以文件或文件段为单位的优缺"
tags:
  - P2P
---
...
![](images/img-modify-603c058341ce9c203208a711be37c5c6.png)
