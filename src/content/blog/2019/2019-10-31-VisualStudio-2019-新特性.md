...
![](images/img-lindexi%2F201941194410257.png)

在设置里面默认打开了允许并行项目初始化，如果打开大项目就会发现整个 CPU 和硬盘都在被 VisualStudio 使用，这样可以做到很快的加载

![](images/img-lindexi%2F201941194516172.png)
...
![](images/img-lindexi%2F20194119465644.png)

然后对代码还有新的高亮

![](images/img-lindexi%2F201941194638185.png)

在 Windows10 会启动 Per-Monitor Awareness 提高清晰

![](images/img-lindexi%2F20194119471192.png)
...
![](images/img-lindexi%2F201941195235982.png)

可以发现 VisualStudio 2019 带来一波很有用的性能提示，但是也有另一些没有什么用的性能提升，如性能管理器

![](images/img-lindexi%2F201941195333378.png)

打开这个界面可以看到基本只有一个不能卸载的插件是降低性能

![](images/img-lindexi%2F201941195359275.png)
...
![](images/img-lindexi%2F201941195919863.png)
...
![](images/img-lindexi%2F20194120119454.png)

点击热路径就会显示建议优化的调用

![](images/img-lindexi%2F201941201136511.png)

对语言 与 .NET Core 也有很多优化，特别是 .NET Core 桌面开发

![](images/img-lindexi%2F201941201246899.png)

还有很多有趣的功能，就需要小伙伴下载安装

<!-- ![](images/img-lindexi%2F20194120133155.png) -->

![](images/img-lindexi%2F20194310939421.png)
