...
pubDatetime: 2023-12-09 09:27:59
modDatetime: 2024-08-06 12:43:41
slug: WPF-尝试使用-WinML-做一个简单的手写数字识别应用
description: "WPF 尝试使用 WinML 做一个简单的手写数字识别应用"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 尝试使用 WinML 做一个简单的手写数字识别应用0.png) -->
![](images/img-modify-e3688acc71ba861a6c81953072feda42.jpg)
...
<!-- ![](images/img-WPF 尝试使用 WinML 做一个简单的手写数字识别应用1.png) -->
![](images/img-modify-f0ac1d724ce6c8cf02cb4861c5a3be3f.jpg)
