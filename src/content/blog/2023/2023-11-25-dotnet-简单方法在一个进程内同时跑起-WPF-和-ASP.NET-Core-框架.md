...
pubDatetime: 2023-11-25 10:09:51
modDatetime: 2025-08-21 01:02:29
slug: dotnet-简单方法在一个进程内同时跑起-WPF-和-ASP.NET-Core-框架
description: "dotnet 简单方法在一个进程内同时跑起 WPF 和 ASP.NET Core 框架"
tags:
  - WPF
  - dotnet
  - ASP.NETCore
...
<!-- ![](images/img-dotnet 简单方法在一个进程内同时跑起 WPF 和 ASP.NET Core 框架0.png) -->
![](images/img-modify-052593ea4708b1cd8c377558d409c6a2.jpg)
