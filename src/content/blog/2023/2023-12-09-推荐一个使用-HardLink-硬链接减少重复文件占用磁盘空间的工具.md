...
pubDatetime: 2023-12-09 02:59:42
modDatetime: 2024-08-06 12:43:44
slug: 推荐一个使用-HardLink-硬链接减少重复文件占用磁盘空间的工具
description: "推荐一个使用 HardLink 硬链接减少重复文件占用磁盘空间的工具"
---
...
<!-- ![](images/img-推荐一个使用 HardLink 硬链接减少重复文件占用磁盘空间的工具0.png) -->
![](images/img-modify-0c3503ec9c111733f3ef495b2735d02f.jpg)
