...
pubDatetime: 2020-07-20 09:58:20
modDatetime: 2024-05-20 08:22:03
slug: WPF-绑定继承的样式提示-只能根据带有基类型-IFrameworkInputElement-的目标类型的-Style-样式
description: "WPF 绑定继承的样式提示 只能根据带有基类型 IFrameworkInputElement 的目标类型的 Style 样式"
tags:
  - WPF
---
