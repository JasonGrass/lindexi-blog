---
title: "WPF 开机启动因为触摸初始化锁住界面显示"
pubDatetime: 2020-06-16 03:29:15
modDatetime: 2024-08-06 12:43:41
slug: WPF-开机启动因为触摸初始化锁住界面显示
description: "WPF 开机启动因为触摸初始化锁住界面显示"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 开机启动因为触摸初始化锁住界面显示0.png) -->

![](images/img-modify-f760dab6441c3a6db572e130b30132be.jpg)

实际上的进入锁的代码是没有意义的，需要看是业务上哪里进入了锁

从调用堆栈里面，如下图，可以看到是 PenThreadWorker.WorkerGetTabletsInfo 方法在等待锁

<!-- ![](images/img-WPF 开机启动因为触摸初始化锁住界面显示1.png) -->

![](images/img-modify-55dbd1c6a174bafe47a7a19ed16375d9.jpg)

通过 [WPF 触摸到事件](https://blog.lindexi.com/post/WPF-%E8%A7%A6%E6%91%B8%E5%88%B0%E4%BA%8B%E4%BB%B6.html ) 可以了解到这是在等待触摸线程执行

<!-- ![](images/img-WPF 开机启动因为触摸初始化锁住界面显示2.png) -->

![](images/img-modify-46c4e29685e1c3e5d236db66a1dcecc2.jpg)
...
<!-- ![](images/img-WPF 开机启动因为触摸初始化锁住界面显示3.png) -->

![](images/img-modify-ed2b292436592a345da9f556461a5679.jpg)
