...
pubDatetime: 2020-01-13 00:49:53
modDatetime: 2024-08-06 12:43:27
slug: dotnet-core-通过-frp-发布自己的网站
description: "dotnet core 通过 frp 发布自己的网站"
tags:
  - dotnet
  - dotnetcore
  - frp
...
<!-- ![](images/img-dotnet core 通过 frp 发布自己的网站1.png) -->

![](images/img-modify-f86319af68826907639622259e77d485.png)

在这里写入 Host 或 Name 输入 server 作为你二级域名，然后在 Value 输入你的服务器地址

这里的 Host 的名字可以随意更改，但是这个值会在下面使用到

<!-- ![](images/img-dotnet core 通过 frp 发布自己的网站0.png) -->

![](images/img-modify-be8e845c27628adc45705c1c27431ec1.png)
