...
pubDatetime: 2020-04-14 01:00:26
modDatetime: 2024-08-06 12:43:40
slug: WPF-动画实战-点击时显示圆圈淡出效果
description: "WPF 动画实战 点击时显示圆圈淡出效果"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 动画实战 点击时显示圆圈淡出效果0.gif) -->

![](images/img-lindexi%2F%25E7%2582%25B9%25E5%2587%25BB%25E6%2597%25B6%-modify-cb01af4a7e0af637b90b0b269abf0f3c.gif)

本文的控件只是一个简单的 Canvas 控件，可以将本文的这个控件替换为你自己需要的控件。或者复制本文的代码，放在你自己的项目里面，只需要让你的项目里面有一个 Canvas 同时这个 Canvas 能接收鼠标事件就能作出本文效果

先在界面放一个 Canvas 控件

<!-- ![](images/img-WPF 动画实战 点击时显示圆圈淡出效果1.png) -->

![](images/img-lindexi%2F20204149406235.jpg)
