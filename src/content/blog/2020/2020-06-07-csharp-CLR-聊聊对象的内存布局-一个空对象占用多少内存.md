...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存0.png) -->

![](images/img-modify-41160f01ee24d109333290b2df61369d.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存1.png) -->

![](images/img-modify-00339465c30a06b082e28db77ced8ee3.jpg)

按下回车之后将会自动将变量名修改这个变量对象的内存的地址

<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存2.png) -->

![](images/img-modify-8323196faac09417339692dc7473bce7.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存3.png) -->

![](images/img-modify-98ea4007c73cfadc89c057a9a5703b22.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存4.png) -->

![](images/img-modify-160fbabc15a55c375972e9e11392d877.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存5.png) -->

![](images/img-modify-7de3c6e1e80f67d6cff320604c559d84.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存6.png) -->

![](images/img-modify-e9d04f3ded92d9bdc8008109d8455699.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存7.png) -->

<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存8.png) -->

![](images/img-modify-628baa2fddd1afb26dc45fe9ed7908a9.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存9.png) -->

<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存10.png) -->

![](images/img-modify-cd7047e7f7e2134f66ea9b5b671043d3.jpg)
...
<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存11.png) -->

<!-- ![](images/img-C# CLR 聊聊对象的内存布局 一个空对象占用多少内存12.png) -->

![](images/img-modify-ec88bc43574000025306c3c6ee93b37e.jpg)
