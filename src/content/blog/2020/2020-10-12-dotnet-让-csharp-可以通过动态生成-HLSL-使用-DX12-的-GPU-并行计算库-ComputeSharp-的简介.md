...
pubDatetime: 2020-10-12 12:21:56
modDatetime: 2024-05-20 08:22:04
slug: dotnet-让-C-可以通过动态生成-HLSL-使用-DX12-的-GPU-并行计算库-ComputeSharp-的简介
description: "dotnet 让 C# 可以通过动态生成 HLSL 使用 DX12 的 GPU 并行计算库 ComputeSharp 的简介"
tags:
  - dotnet
  - C#
---
