...
<!-- ![](images/img-dotnet core 应用是如何跑起来的 通过自己写一个 dotnet host 理解运行过程0.png) -->

![](images/img-modify-f66294b42bddbdaeb4e04621555b884b.jpg)
...
<!-- ![](images/img-dotnet core 应用是如何跑起来的 通过自己写一个 dotnet host 理解运行过程1.png) -->

![](images/img-modify-5468ba30eaed03e725881c9ce7f279cb.jpg)
