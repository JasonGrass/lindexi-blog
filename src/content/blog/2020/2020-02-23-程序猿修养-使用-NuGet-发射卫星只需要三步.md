...
slug: 程序猿修养-使用-NuGet-发射卫星只需要三步
description: "程序猿修养 使用 NuGet 发射卫星只需要三步"
---
...
<!-- ![](images/img-程序猿修养 使用 NuGet 发射卫星只需要三步0.png) -->

![](images/img-modify-8da1baa97d8ecfbbe27896d44c1ae517.jpg)

点击之后可以看到此页面

<!-- ![](images/img-程序猿修养 使用 NuGet 发射卫星只需要三步1.png) -->

![](images/img-modify-581682f8c4fe61dadd73b5105d86f660.jpg)

这里提供了安装 NuGet 库的功能以及卸载库的功能，只需要在搜寻里面输入对应的库的名字，支持模糊搜寻的功能，找到对应的库，点击安装就可以了

<!-- ![](images/img-程序猿修养 使用 NuGet 发射卫星只需要三步2.png) -->

![](images/img-modify-649e14bfad521e4e4a70bc6532996fa7.jpg)
