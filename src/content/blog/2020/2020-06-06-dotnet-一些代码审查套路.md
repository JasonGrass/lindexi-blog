...
pubDatetime: 2020-06-06 01:19:16
modDatetime: 2024-08-06 12:43:29
slug: dotnet-一些代码审查套路
description: "dotnet 一些代码审查套路"
tags:
  - dotnet
---
...
<!-- ![](images/img-dotnet 一些代码审查套路0.png) -->

![](images/img-modify-99618b387ecb9af15174e59030b948d4.jpg)

这是我截图某一天的一个核心项目的在 Gitlab 上的 MR 情况，我觉得头像应该是不用保密的，这样知道的小伙伴自然就知道了。对了，那些挂了超过3天的都是标记 WIP 还在开发中的

<!-- ![](images/img-dotnet 一些代码审查套路1.png) -->

![](images/img-modify-e7804f78e58b27f3a6ea72cfb04f490c.jpg)
...
<!-- ![](images/img-dotnet 一些代码审查套路3.png) -->

![](images/img-modify-df2aff67b5550ad72556485fdd50601c.jpg)
...
<!-- ![](images/img-dotnet 一些代码审查套路2.png) -->

![](images/img-modify-5c66f34baa13a4513150b14049f8253e.jpg)
