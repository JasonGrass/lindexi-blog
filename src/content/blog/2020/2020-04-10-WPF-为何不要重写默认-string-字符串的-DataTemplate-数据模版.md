...
pubDatetime: 2020-04-10 00:27:42
modDatetime: 2024-08-06 12:43:39
slug: WPF-为何不要重写默认-string-字符串的-DataTemplate-数据模版
description: "WPF 为何不要重写默认 string 字符串的 DataTemplate 数据模版"
tags:
  - WPF
---
...
<!-- ![](images/img-WPF 为何不要重写默认 string 字符串的 DataTemplate 数据模版0.png) -->

![](images/img-modify-c1e021cd6e98f27b139726a5159b0072.jpg)
