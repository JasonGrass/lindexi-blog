---
title: "开源项目"
pubDatetime: 2020-02-29 03:32:39
modDatetime: 2025-11-05 01:42:55
slug: 开源项目
description: "开源项目"
---
...
![](images/img-modify-7a05f074ba37b8e32ba3a945be0fa510.jpg)

附加现有的.NET程序，然后自己反编译出需要调试的代码。隐约觉得，这个可以成为远程调试客户问题的大杀器

### RX-Explorer

<!-- ![](images/img-开源项目5.png) -->

![](images/img-modify-a502682168edafa342954197ff018173.jpg)
...
<!-- ![](images/img-开源项目4.png) -->

![](images/img-modify-a8c8079329fdbea7d25166523c2c4ae5.jpg)
...
如下图是我输入 `Conso` 时自动给出的智能提示内容

<!-- ![](images/img-开源项目13.png) -->
![](images/img-modify-d7af085102824ead44bd74d004617577.jpg)

当我应用智能提示补全 `Console` 之后，再输入 `.wr` 时，就会给出方法的智能提示补全，如下图

<!-- ![](images/img-开源项目14.png) -->
![](images/img-modify-81c45fb0a7038794e465fc28f37fa0a7.jpg)

此命令行工具支持定义方法和类型，可以自动补全所定义的方法，如下图所示

<!-- ![](images/img-开源项目15.png) -->
![](images/img-modify-87a58192e1523e94e2606a22b96fbe29.jpg)
...
![](images/img-modify-5110bb7b2f58a73f1516b6e164dc9352.png)
...
![](images/img-lindexi-2025115942198196.jpg)

[imxcstar/LVGLSharp: LVGL C# 绑定库 LVGL C# Binding Library](https://github.com/imxcstar/LVGLSharp )
...
<!-- ![](images/img-开源项目1.png) -->

![](images/img-modify-e8997c06da8a160c410d46b8e9513b0d.jpg)

![](images/img-emoji.wpf.gif)
...
<!-- ![](images/img-开源项目2.png) -->

![](images/img-modify-b66a77985e8a174d660ea29b454d2617.jpg)
...
<!-- ![](images/img-开源项目6.png) -->

![](images/img-modify-9e28b73cc34d4577de7db503521336c5.jpg)
...
![](images/img-modify-517cf0864ad371013fa372e1af6855cf.gif)
...
![](images/img-quick_presentation.gif)
...
<!-- ![](images/img-开源项目10.png) -->

![](images/img-modify-015acc53d3891fa7afb2a6768b73b868.jpg)
...
![](images/img-modify-13cad7acbdf301527d401ef91fc4b1d7.jpg)
...
[DinoChan/wpf_design_and_animation_lab](https://github.com/DinoChan/wpf_design_and_animation_lab/tree/master )

### nodify

A collection of highly performant controls for node based editors designed for MVVM.

![](https://camo.githubusercontent.com/d42b8b3bd9bec65eae2e7ca0ffbf33392d5b3dc8c9c6944b5707e7f0cab43091/68747470733a2f2f692e696d6775722e636f6d2f617172557075502e676966)

可以制作出类似 Unity3D 的动画或 Blander 设计的效果，也可以做低代码项目

[miroiu/nodify: Highly performant and modular controls for node-based editors designed for data-binding and MVVM.](https://github.com/miroiu/nodify )

教程：

- [Nodify学习 一：介绍与使用 - 可乐_加冰 - 博客园](https://www.cnblogs.com/zt199510/p/18306876 )
- [Nodify学习 二：添加节点 - 可乐_加冰 - 博客园](https://www.cnblogs.com/zt199510/p/18308687 )
- [Nodify学习 三：连接器 - 可乐_加冰 - 博客园](https://www.cnblogs.com/zt199510/p/18310735 )
- [Nodify学习 四：预先连接 - 可乐_加冰 - 博客园](https://www.cnblogs.com/zt199510/p/18315373 )
- [Nodify学习 伍：添加移除连接控制器,设置节点初始位置 - 可乐_加冰 - 博客园](https://www.cnblogs.com/zt199510/p/18315740 )
...
[AdamEssenmacher/MemoryToolkit.Maui: A developer toolkit for detecting, diagnosing, and mitigating memory leaks in .NET MAUI applications.](https://github.com/AdamEssenmacher/MemoryToolkit.Maui )

## UNO 界面库

### UnoKeyboard

<!-- ![](images/img-开源项目16.png) -->
![](images/img-modify-fe5fac0917c12faaf15a22b5dc6fc7a7.jpg)

<https://github.com/mcNets/UnoKeyboard>

## WinForms 界面库

[AntdUI/AntdUI: 👚 Winform interface library based on the Ant Design](https://github.com/AntdUI/AntdUI )
...
<!-- ![](images/img-开源项目8.png) -->

![](images/img-modify-4e4b16ef2aa7c643f0308fb82678ed18.jpg)
...
<!-- ![](images/img-开源项目0.png) -->

![](images/img-modify-9fb7988c4b6066d7b6ceec11f76eec4d.png)
...
[jevonsflash/MatoProductivity: 开源记事类App](https://github.com/jevonsflash/MatoProductivity )

### V-Control

V-Control是适用于.NET MAUI 的组件库(Component)，它提供了一组开箱即用的 UI 控件，可快速搭建面向业务的应用程序界面

[jevonsflash/V-Control: An out-of-the-box .NET MAUI component library](https://github.com/jevonsflash/V-Control)
...
- [.NET 轻量级 命令行工具 CSharpRepl - 小码编匠 - 博客园](https://www.cnblogs.com/1312mn/p/18321908 )
- [CSharpRepl：一个跨平台轻量级的C#命令行工具-CSDN博客](https://blog.csdn.net/sd7o95o/article/details/140683572 )
...
[miroiu/string-math: Evaluates a math expression from a string. Supports variables and custom operators.](https://github.com/miroiu/string-math )
...
[SlimeNull/FFmpegVideoRenderer: 基于 FFmpeg 的视频渲染器](https://github.com/SlimeNull/FFmpegVideoRenderer )
...
![](images/img-modify-17268111a3b81d546984a13aa0c4cc73.jpg)
...
![](images/img-122925974-f17ead00-d399-11eb-9c57-9b2f14dd5973.gif)
...
<!-- ![](images/img-开源项目9.png) -->

![](images/img-modify-6b55191d490c09d80078f68df07c5b3f.jpg)
...
<!-- ![](images/img-开源项目11.png) -->

![](images/img-modify-f4c439f2569207892f372973c42b88a2.jpg)

### Flow.Launcher

![](images/img-207167068-2196d2a3-2caa-4856-958b-a780fbda95c6.gif)
...
[hbdzh/JianXiEditor: WPF开发的代码编辑器](https://github.com/hbdzh/JianXiEditor )

### qBittorrentCompanion

A remote client for qBittorrent written in C#/Avalonia

<!-- ![](images/img-开源项目17.png) -->
![](images/img-modify-0f1e6fc07da71c881259f34f35780b72.jpg)
...
[liukuo362573/YiShaAdmin: 基于 .NET Core MVC 的权限管理系统，代码易读易懂、界面简洁美观](https://github.com/liukuo362573/YiShaAdmin )
...
<!-- ![](images/img-开源项目3.png) -->

![](images/img-modify-917dec52f04b5a4a9cd520d798a33132.jpg)
...
![](images/img-modify-84095f6e6dc5389e4faf9450109a6479.jpg)
