...
slug: WPF-使用-MAUI-的自绘制逻辑
description: "WPF 使用 MAUI 的自绘制逻辑"
tags:
  - MAUI
  - WPF
  - MauiGraphics
...
<!-- ![](images/img-WPF 使用 MAUI 的自绘制逻辑0.png) -->

![](images/img-modify-08290199e8575e8282fee69c5dad88b8.jpg)
...
<!-- ![](images/img-WPF 使用 MAUI 的自绘制逻辑1.png) -->

![](images/img-modify-891db7e7cde384c473ffd23dc6b2cedb.jpg)
...
<!-- ![](images/img-WPF 使用 MAUI 的自绘制逻辑2.png) -->

![](images/img-modify-fa57c0011fee69ddbfddb3e0bb907138.jpg)
...
<!-- ![](images/img-WPF 使用 MAUI 的自绘制逻辑3.png) -->

![](images/img-modify-4542fd5073c5b3a786eded72d5f32085.jpg)
