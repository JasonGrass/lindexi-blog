...
pubDatetime: 2022-06-20 00:03:37
modDatetime: 2024-08-06 12:43:31
slug: dotnet-调试应用启动闪退的方法
description: "dotnet 调试应用启动闪退的方法"
tags:
  - dotnet
---
...
![](images/img-modify-8396650263ec1f6caad047f8ee24e684.jpg)

接着点击创建新配置文件，选择可执行文件

![](images/img-modify-2db7f084421edd2994925a52e96d3e70.jpg)

接下来选择需要调试启动失败的应用的路径

![](images/img-modify-2bb28b17136570cfea3056d1e662b65e.jpg)

为了同时捕获一些本机异常，还请勾选“启用本机代码调试”也就是混合调试模式。本机异常包括 Window Runtime 抛出的异常，基础的 Win32 调用包含的非返回值的错误的异常，以及外部 C++ 等库的异常等

![](images/img-modify-ffeddd99d04553a74ff6483b621a770d.jpg)
...
![](images/img-modify-4d9d9f36954f61a266e58854aa966bd9.jpg)
