...
![](images/img-lindexi%2F20226182047394478.jpg)

接着点击创建新配置文件，选择可执行文件

![](images/img-lindexi%2F20226182049315232.jpg)

接下来选择需要调试启动失败的应用的路径

![](images/img-lindexi%2F20226182050218037.jpg)

为了同时捕获一些本机异常，还请勾选“启用本机代码调试”也就是混合调试模式。本机异常包括 Window Runtime 抛出的异常，基础的 Win32 调用包含的非返回值的错误的异常，以及外部 C++ 等库的异常等

![](images/img-lindexi%2F2022618205318555.jpg)
...
![](images/img-lindexi%2F20226182113182818.jpg)
